...
public class Modelo {
    ...
    public void cochesPorMarca() throws SQLException {
        String sentenciaSql = "call mostrarCochesMarca";
    ...
    public ResultSet obtenerDatos1() throws SQLException {
        ...
        String consulta ="SELECT marca,COUNT(*) FROM coches GROUP BY marca";
        PreparedStatement sentencia=null;
        sentencia=conexion.prepareStatement(consulta);
        ResultSet resultado=sentencia.executeQuery();
        return resultado;
